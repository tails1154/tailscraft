...
public class SPacketChunkData implements Packet<INetHandlerPlayClient> {
	...
	public SPacketChunkData(Chunk p_i47124_1_, int p_i47124_2_) {
		...
		p_i47124_1_.alfheim$getLightingEngine().processLightUpdates();
	...
	public void writePacketData(PacketBuffer buf) throws IOException {
		...
		for (int i = 0; i < this.tileEntityTags.size(); i++) {
			buf.writeNBTTagCompoundToBuffer(this.tileEntityTags.get(i));
		}
	}
