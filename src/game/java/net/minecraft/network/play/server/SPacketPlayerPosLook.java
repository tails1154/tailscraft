...
public class SPacketPlayerPosLook implements Packet<INetHandlerPlayClient> {
	...
	public static enum EnumFlags {
		...
		public static Set<SPacketPlayerPosLook.EnumFlags> unpack(int flags) {
			EnumSet set = EnumSet.noneOf(SPacketPlayerPosLook.EnumFlags.class);
			SPacketPlayerPosLook.EnumFlags[] types = values();

			for (int i = 0; i < types.length; ++i) {
				SPacketPlayerPosLook.EnumFlags spacketplayerposlook$enumflags = types[i];
