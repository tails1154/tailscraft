...
public abstract class StructureComponent {
	 ...
	 */
	public abstract boolean addComponentParts(World worldIn, EaglercraftRandom randomIn,
	...
	protected void func_189914_a(World p_189914_1_, StructureBoundingBox p_189914_2_, EaglercraftRandom p_189914_3_,
	 ...
	 */
	protected boolean generateChest(World worldIn, StructureBoundingBox structurebb, EaglercraftRandom randomIn, int x,
			int y, int z, ResourceLocation loot) {
		BlockPos blockpos = new BlockPos(this.getXWithOffset(x, z), this.getYWithOffset(y), this.getZWithOffset(x, z));
		return this.func_191080_a(worldIn, structurebb, randomIn, blockpos, loot, (IBlockState) null);
	}

	protected boolean func_191080_a(World p_191080_1_, StructureBoundingBox p_191080_2_, EaglercraftRandom p_191080_3_,
	...
	protected boolean createDispenser(World p_189419_1_, StructureBoundingBox p_189419_2_,
			EaglercraftRandom p_189419_3_, int p_189419_4_, int p_189419_5_, int p_189419_6_, EnumFacing p_189419_7_,
	...
	protected void func_189915_a(World p_189915_1_, StructureBoundingBox p_189915_2_, EaglercraftRandom p_189915_3_,
	...
	public abstract static class BlockSelector {
		...
		public abstract void selectBlocks(EaglercraftRandom rand, int x, int y, int z, boolean p_75062_5_);
