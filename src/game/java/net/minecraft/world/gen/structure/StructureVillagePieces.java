...
public class StructureVillagePieces {
	public static void registerVillagePieces() {
		MapGenStructureIO.registerStructureComponent(StructureVillagePieces.House1.class, StructureVillagePieces.House1::new, "ViBH");
		MapGenStructureIO.registerStructureComponent(StructureVillagePieces.Field1.class, StructureVillagePieces.Field1::new, "ViDF");
		MapGenStructureIO.registerStructureComponent(StructureVillagePieces.Field2.class, StructureVillagePieces.Field2::new, "ViF");
		MapGenStructureIO.registerStructureComponent(StructureVillagePieces.Torch.class, StructureVillagePieces.Torch::new, "ViL");
		MapGenStructureIO.registerStructureComponent(StructureVillagePieces.Hall.class, StructureVillagePieces.Hall::new, "ViPH");
		MapGenStructureIO.registerStructureComponent(StructureVillagePieces.House4Garden.class, StructureVillagePieces.House4Garden::new, "ViSH");
		MapGenStructureIO.registerStructureComponent(StructureVillagePieces.WoodHut.class, StructureVillagePieces.WoodHut::new, "ViSmH");
		MapGenStructureIO.registerStructureComponent(StructureVillagePieces.Church.class, StructureVillagePieces.Church::new, "ViST");
		MapGenStructureIO.registerStructureComponent(StructureVillagePieces.House2.class, StructureVillagePieces.House2::new, "ViS");
		MapGenStructureIO.registerStructureComponent(StructureVillagePieces.Start.class, StructureVillagePieces.Start::new, "ViStart");
		MapGenStructureIO.registerStructureComponent(StructureVillagePieces.Path.class, StructureVillagePieces.Path::new, "ViSR");
		MapGenStructureIO.registerStructureComponent(StructureVillagePieces.House3.class, StructureVillagePieces.House3::new, "ViTRH");
		MapGenStructureIO.registerStructureComponent(StructureVillagePieces.Well.class, StructureVillagePieces.Well::new, "ViW");
	}

	public static List<StructureVillagePieces.PieceWeight> getStructureVillageWeightedPieceList(
			EaglercraftRandom random, int size) {
	...
	private static StructureVillagePieces.Village findAndCreateComponentFactory(StructureVillagePieces.Start start,
			StructureVillagePieces.PieceWeight weight, List<StructureComponent> structureComponents,
			EaglercraftRandom rand, int structureMinX, int structureMinY, int structureMinZ, EnumFacing facing,
			int componentType) {
	...
	private static StructureVillagePieces.Village generateComponent(StructureVillagePieces.Start start,
			List<StructureComponent> structureComponents, EaglercraftRandom rand, int structureMinX, int structureMinY,
	...
	private static StructureComponent generateAndAddRoadPiece(StructureVillagePieces.Start start,
			List<StructureComponent> p_176069_1_, EaglercraftRandom rand, int p_176069_3_, int p_176069_4_,
			int p_176069_5_, EnumFacing facing, int p_176069_7_) {
	...
	public static class Church extends StructureVillagePieces.Village {
		...
		public Church(StructureVillagePieces.Start start, int type, EaglercraftRandom rand,
		...
		public static StructureVillagePieces.Church createPiece(StructureVillagePieces.Start start,
				List<StructureComponent> p_175854_1_, EaglercraftRandom rand, int p_175854_3_, int p_175854_4_,
	...
	public static class Field1 extends StructureVillagePieces.Village {
		...
		public Field1(StructureVillagePieces.Start start, int type, EaglercraftRandom rand,
		...
		private Block getRandomCropType(EaglercraftRandom rand) {
		...
		public static StructureVillagePieces.Field1 createPiece(StructureVillagePieces.Start start,
				List<StructureComponent> p_175851_1_, EaglercraftRandom rand, int p_175851_3_, int p_175851_4_,
	...
	public static class Field2 extends StructureVillagePieces.Village {
		...
		public Field2(StructureVillagePieces.Start start, int p_i45569_2_, EaglercraftRandom rand,
		...
		public static StructureVillagePieces.Field2 createPiece(StructureVillagePieces.Start start,
				List<StructureComponent> p_175852_1_, EaglercraftRandom rand, int p_175852_3_, int p_175852_4_,
	...
	public static class Hall extends StructureVillagePieces.Village {
		...
		public Hall(StructureVillagePieces.Start start, int type, EaglercraftRandom rand,
		...
		public static StructureVillagePieces.Hall createPiece(StructureVillagePieces.Start start,
				List<StructureComponent> p_175857_1_, EaglercraftRandom rand, int p_175857_3_, int p_175857_4_,
	...
	public static class House1 extends StructureVillagePieces.Village {
		...
		public House1(StructureVillagePieces.Start start, int type, EaglercraftRandom rand,
		...
		public static StructureVillagePieces.House1 createPiece(StructureVillagePieces.Start start,
				List<StructureComponent> p_175850_1_, EaglercraftRandom rand, int p_175850_3_, int p_175850_4_,
	...
	public static class House2 extends StructureVillagePieces.Village {
		...
		public House2(StructureVillagePieces.Start start, int type, EaglercraftRandom rand,
		...
		public static StructureVillagePieces.House2 createPiece(StructureVillagePieces.Start start,
				List<StructureComponent> p_175855_1_, EaglercraftRandom rand, int p_175855_3_, int p_175855_4_,
	...
	public static class House3 extends StructureVillagePieces.Village {
		...
		public House3(StructureVillagePieces.Start start, int type, EaglercraftRandom rand,
		...
		public static StructureVillagePieces.House3 createPiece(StructureVillagePieces.Start start,
				List<StructureComponent> p_175849_1_, EaglercraftRandom rand, int p_175849_3_, int p_175849_4_,
	...
	public static class House4Garden extends StructureVillagePieces.Village {
		...
		public House4Garden(StructureVillagePieces.Start start, int p_i45566_2_, EaglercraftRandom rand,
		...
		public static StructureVillagePieces.House4Garden createPiece(StructureVillagePieces.Start start,
				List<StructureComponent> p_175858_1_, EaglercraftRandom rand, int p_175858_3_, int p_175858_4_,
	...
	public static class Path extends StructureVillagePieces.Road {
		...
		public Path(StructureVillagePieces.Start start, int p_i45562_2_, EaglercraftRandom rand,
		...
		public static StructureBoundingBox findPieceBox(StructureVillagePieces.Start start,
				List<StructureComponent> p_175848_1_, EaglercraftRandom rand, int p_175848_3_, int p_175848_4_,
				int p_175848_5_, EnumFacing facing) {
	...
	public static class Start extends StructureVillagePieces.Well {
		...
		public Start(BiomeProvider chunkManagerIn, int p_i2104_2_, EaglercraftRandom rand, int p_i2104_4_,
				int p_i2104_5_, List<StructureVillagePieces.PieceWeight> p_i2104_6_, int p_i2104_7_) {
	...
	public static class Torch extends StructureVillagePieces.Village {
		...
		public Torch(StructureVillagePieces.Start start, int p_i45568_2_, EaglercraftRandom rand,
		...
		public static StructureBoundingBox findPieceBox(StructureVillagePieces.Start start,
				List<StructureComponent> p_175856_1_, EaglercraftRandom rand, int p_175856_3_, int p_175856_4_,
				int p_175856_5_, EnumFacing facing) {
	...
	abstract static class Village extends StructureComponent {
		...
		protected StructureComponent getNextComponentNN(StructureVillagePieces.Start start,
				List<StructureComponent> structureComponents, EaglercraftRandom rand, int p_74891_4_, int p_74891_5_) {
			EnumFacing enumfacing = this.getCoordBaseMode();
		...
		protected StructureComponent getNextComponentPP(StructureVillagePieces.Start start,
				List<StructureComponent> structureComponents, EaglercraftRandom rand, int p_74894_4_, int p_74894_5_) {
			EnumFacing enumfacing = this.getCoordBaseMode();
		...
		protected void func_189927_a(World p_189927_1_, StructureBoundingBox p_189927_2_, EaglercraftRandom p_189927_3_,
	...
	public static class Well extends StructureVillagePieces.Village {
		...
		public Well(StructureVillagePieces.Start start, int type, EaglercraftRandom rand, int x, int z) {
			super(start, type);
	...
	public static class WoodHut extends StructureVillagePieces.Village {
		...
		public WoodHut(StructureVillagePieces.Start start, int type, EaglercraftRandom rand,
		...
		public static StructureVillagePieces.WoodHut createPiece(StructureVillagePieces.Start start,
				List<StructureComponent> p_175853_1_, EaglercraftRandom rand, int p_175853_3_, int p_175853_4_,
