...
public class WoodlandMansion extends MapGenStructure {
	...
	protected boolean canSpawnStructureAtCoords(int chunkX, int chunkZ) {
		...
		int k = i / 80;
		int l = j / 80;
		EaglercraftRandom random = this.worldObj.setRandomSeed(k, l, 10387319);
		k = k * 80;
		l = l * 80;
	...
	public static class Start extends StructureStart {
		...
		public Start(World p_i47235_1_, ChunkGeneratorOverworld p_i47235_2_, EaglercraftRandom p_i47235_3_,
				int p_i47235_4_, int p_i47235_5_) {
			super(p_i47235_4_, p_i47235_5_);
			this.func_191092_a(p_i47235_1_, p_i47235_2_, p_i47235_3_, p_i47235_4_, p_i47235_5_);
		}

		private void func_191092_a(World p_191092_1_, ChunkGeneratorOverworld p_191092_2_,
				EaglercraftRandom p_191092_3_, int p_191092_4_, int p_191092_5_) {
