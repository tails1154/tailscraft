...
public class AnvilChunkLoader implements IChunkLoader {
	...
	public AnvilChunkLoader(VFile2 chunkSaveLocationIn, DataFixer dataFixerIn) {
	...
	public void saveChunk(World worldIn, Chunk chunkIn) throws MinecraftException, IOException {
		...
		try {
			...
			this.writeChunkData(chunkIn.getChunkCoordIntPair(), nbttagcompound);
	 ...
	 */
	protected void writeChunkToNBT(Chunk chunkIn, World worldIn, NBTTagCompound compound) {
		alfheim$writeNeighborLightChecksToNBT(chunkIn, compound);
		...
		compound.setBoolean("LightPopulated", chunkIn.alfheim$isLightInitialized());
	...
	private Chunk readChunkFromNBT(World worldIn, NBTTagCompound compound) {
		...
		chunk.alfheim$setLightInitialized(compound.getBoolean("LightPopulated"));
