...
public class EntityZombie extends EntityMob {
	...
	private static final EaglercraftUUID BABY_SPEED_BOOST_ID = EaglercraftUUID
	...
	private static final DataParameter<Boolean> IS_CHILD = EntityDataManager.<Boolean>createKey(12,
			DataSerializers.BOOLEAN);
	private static final DataParameter<Integer> VILLAGER_TYPE = EntityDataManager.<Integer>createKey(13,
			DataSerializers.VARINT);
	private static final DataParameter<Boolean> ARMS_RAISED = EntityDataManager.<Boolean>createKey(14,
			DataSerializers.BOOLEAN);
