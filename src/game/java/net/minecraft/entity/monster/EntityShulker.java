...
public class EntityShulker extends EntityGolem implements IMob {
	private static final EaglercraftUUID COVERED_ARMOR_BONUS_ID = EaglercraftUUID
			.fromString("7E0292F2-9434-48D5-A29F-9583AF7DF27F");
	...
	protected static final DataParameter<EnumFacing> ATTACHED_FACE = EntityDataManager.<EnumFacing>createKey(12,
			DataSerializers.FACING);
	protected static final DataParameter<Optional<BlockPos>> ATTACHED_BLOCK_POS = EntityDataManager
			.<Optional<BlockPos>>createKey(13, DataSerializers.OPTIONAL_BLOCK_POS);
	protected static final DataParameter<Byte> PEEK_TICK = EntityDataManager.<Byte>createKey(14, DataSerializers.BYTE);
	protected static final DataParameter<Byte> field_190770_bw = EntityDataManager.<Byte>createKey(15,
