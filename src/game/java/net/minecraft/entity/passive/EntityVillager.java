...
public class EntityVillager extends EntityAgeable implements INpc, IMerchant {
	...
	private static final DataParameter<Integer> PROFESSION = EntityDataManager.<Integer>createKey(13,
	 ...
	 */
	private static List<List<? extends Object>> DEFAULT_TRADE_LIST_MAP = null;
	...
	public static void bootstrap() {
		DEFAULT_TRADE_LIST_MAP = Arrays.asList(
				Arrays.asList(Arrays.asList(Arrays.asList(
						...
						Arrays.asList(
								new EntityVillager.ListItemForEmeralds(Items.COOKIE,
										new EntityVillager.PriceInfo(-10, -6)),
				...
				Arrays.asList(
						...
						Arrays.asList(
								Arrays.asList(new EntityVillager.EmeraldForItems(Items.PAPER,
										new EntityVillager.PriceInfo(24, 36))),
								Arrays.asList(new EntityVillager.EmeraldForItems(Items.COMPASS,
										new EntityVillager.PriceInfo(1, 1))),
								Arrays.asList(new EntityVillager.ListItemForEmeralds(Items.MAP,
				...
				Arrays.asList(Arrays.asList(Arrays.asList(
						...
						Arrays.asList(
								new EntityVillager.ListItemForEmeralds(Items.ENDER_PEARL,
				...
				Arrays.asList(Arrays.asList(Arrays.asList(
						...
						Arrays.asList(Arrays.asList(
								...
								Arrays.asList(new EntityVillager.ListItemForEmeralds(Items.SADDLE,
										new EntityVillager.PriceInfo(8, 10))))),
				Arrays.asList(new EntityVillager.ITradeList[0][]));
	}
	...
	private void populateBuyingList() {
		List<List<List>> aentityvillager$itradelist = (List<List<List>>) DEFAULT_TRADE_LIST_MAP.get(this.getProfession());
		int size = aentityvillager$itradelist.size();
		if (this.careerId != 0 && this.careerLevel != 0) {
			++this.careerLevel;
		} else {
			this.careerId = this.rand.nextInt(size) + 1;
			this.careerLevel = 1;
		}
		...
		if (i >= 0 && i < size) {
			List<List> aentityvillager$itradelist1 = (List<List>) aentityvillager$itradelist.get(i);
	...
	static class EmeraldForItems implements EntityVillager.ITradeList {
		...
		public void func_190888_a(IMerchant p_190888_1_, MerchantRecipeList p_190888_2_,
				EaglercraftRandom p_190888_3_) {
			int i = 1;
	...
	interface ITradeList {
		void func_190888_a(IMerchant p_190888_1_, MerchantRecipeList p_190888_2_, EaglercraftRandom p_190888_3_);
	}
	...
	static class TreasureMapForEmeralds implements EntityVillager.ITradeList {
		...
		public void func_190888_a(IMerchant p_190888_1_, MerchantRecipeList p_190888_2_,
			...
			if (blockpos != null) {
				...
				itemstack.func_190924_f("filled_map." + this.field_190890_b.toLowerCase());
				p_190888_2_.add(
