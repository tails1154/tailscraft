...
public abstract class EntityLiving extends EntityLivingBase {
	private static final DataParameter<Byte> AI_FLAGS = EntityDataManager.<Byte>createKey(11, DataSerializers.BYTE);
	...
	protected void dropLoot(boolean wasRecentlyHit, int lootingModifier, DamageSource source) {
		...
		if (resourcelocation != null) {
			...
			for (ItemStack itemstack : loottable.generateLootForPools(
					this.deathLootTableSeed == 0L ? this.rand : new EaglercraftRandom(this.deathLootTableSeed),
