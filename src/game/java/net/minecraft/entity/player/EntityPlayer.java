...
public abstract class EntityPlayer extends EntityLivingBase {
	private static final DataParameter<Float> ABSORPTION = EntityDataManager.<Float>createKey(11,
			DataSerializers.FLOAT);
	private static final DataParameter<Integer> PLAYER_SCORE = EntityDataManager.<Integer>createKey(12,
			DataSerializers.VARINT);
	protected static final DataParameter<Byte> PLAYER_MODEL_FLAG = EntityDataManager.<Byte>createKey(13,
			DataSerializers.BYTE);
	protected static final DataParameter<Byte> MAIN_HAND = EntityDataManager.<Byte>createKey(14, DataSerializers.BYTE);
	protected static final DataParameter<NBTTagCompound> field_192032_bt = EntityDataManager
			.<NBTTagCompound>createKey(15, DataSerializers.field_192734_n);
	protected static final DataParameter<NBTTagCompound> field_192033_bu = EntityDataManager
			.<NBTTagCompound>createKey(16, DataSerializers.field_192734_n);
	...
	private void func_192028_j(@Nullable NBTTagCompound p_192028_1_) {
		...
		if (!p_192028_1_.hasKey("Silent") || !p_192028_1_.getBoolean("Silent")) {
	...
	protected SoundEvent getHurtSound(DamageSource p_184601_1_) {
		if (p_184601_1_ == DamageSource.onFire) {
			...
			return p_184601_1_ == DamageSource.drown ? SoundEvents.ENTITY_PLAYER_HURT_DROWN
