...
public abstract class Entity implements ICommandSender {
	...
	protected static final DataParameter<Byte> FLAGS = EntityDataManager.<Byte>createKey(0, DataSerializers.BYTE);
	private static final DataParameter<Integer> AIR = EntityDataManager.<Integer>createKey(1, DataSerializers.VARINT);
	private static final DataParameter<String> CUSTOM_NAME = EntityDataManager.<String>createKey(2,
			DataSerializers.STRING);
	private static final DataParameter<Boolean> CUSTOM_NAME_VISIBLE = EntityDataManager.<Boolean>createKey(3,
			DataSerializers.BOOLEAN);
	private static final DataParameter<Boolean> SILENT = EntityDataManager.<Boolean>createKey(4,
			DataSerializers.BOOLEAN);
	private static final DataParameter<Boolean> NO_GRAVITY = EntityDataManager.<Boolean>createKey(5,
			DataSerializers.BOOLEAN);
	...
	protected void doBlockCollisions() {
		AxisAlignedBB axisalignedbb = this.getEntityBoundingBox();
		BlockPos blockpos$pooledmutableblockpos = new BlockPos(axisalignedbb.minX + 0.001D, axisalignedbb.minY + 0.001D, axisalignedbb.minZ + 0.001D);
		BlockPos blockpos$pooledmutableblockpos1 = new BlockPos(axisalignedbb.maxX - 0.001D, axisalignedbb.maxY - 0.001D, axisalignedbb.maxZ - 0.001D);
		BlockPos blockpos$pooledmutableblockpos2 =  new BlockPos();
	...
	public boolean isWet() {
		if (this.inWater) {
			...
			BlockPos blockpos$pooledmutableblockpos = new BlockPos(this.posX, this.posY, this.posZ);
	...
	public int getBrightnessForRender() {
		BlockPos blockpos$mutableblockpos = new BlockPos(MathHelper.floor(this.posX), 0, MathHelper.floor(this.posZ));

		if (this.world.isBlockLoaded(blockpos$mutableblockpos)) {
			blockpos$mutableblockpos.y = MathHelper.floor(this.posY + (double) this.getEyeHeight());
	...
	public float getBrightness() {
		BlockPos blockpos$mutableblockpos = new BlockPos(MathHelper.floor(this.posX), 0,
