...
public class EnchantmentHelper {
	...
	public static float func_191527_a(EntityLivingBase p_191527_0_) {
		int i = getMaxEnchantmentLevel(Enchantments.SWEEPING_EDGE, p_191527_0_);
	 ...
	 */
	public static int calcItemStackEnchantability(EaglercraftRandom rand, int enchantNum, int power, ItemStack stack) {
	 ...
	 */
	public static ItemStack addRandomEnchantment(EaglercraftRandom random, ItemStack p_77504_1_, int p_77504_2_,
	...
	public static List<EnchantmentData> buildEnchantmentList(EaglercraftRandom randomIn, ItemStack itemStackIn,
			int p_77513_2_, boolean allowTreasure) {
