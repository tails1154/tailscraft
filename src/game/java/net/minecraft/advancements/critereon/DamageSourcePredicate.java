...
public class DamageSourcePredicate {
	...
	public static DamageSourcePredicate func_192447_a(@Nullable Object p_192447_0_) {
		if (p_192447_0_ != null) {
			JSONObject jsonobject = (JSONObject) p_192447_0_;
			...
			EntityPredicate entitypredicate = EntityPredicate.func_192481_a(jsonobject.getOptional("direct_entity"));
			EntityPredicate entitypredicate1 = EntityPredicate.func_192481_a(jsonobject.getOptional("source_entity"));
	...
	private static Boolean func_192448_a(JSONObject p_192448_0_, String p_192448_1_) {
		return p_192448_0_.has(p_192448_1_) ? p_192448_0_.getBoolean(p_192448_1_) : null;
	}
}
