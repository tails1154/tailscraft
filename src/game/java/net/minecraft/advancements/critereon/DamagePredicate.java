...
public class DamagePredicate {
	...
	public static DamagePredicate func_192364_a(@Nullable Object p_192364_0_) {
		if (p_192364_0_ != null) {
			JSONObject jsonobject = (JSONObject) p_192364_0_;
			MinMaxBounds minmaxbounds = MinMaxBounds.func_192515_a(jsonobject.getOptional("dealt"));
			MinMaxBounds minmaxbounds1 = MinMaxBounds.func_192515_a(jsonobject.getOptional("taken"));
			Boolean obool = jsonobject.has("blocked") ? jsonobject.getBoolean("blocked") : null;
			EntityPredicate entitypredicate = EntityPredicate.func_192481_a(jsonobject.getOptional("source_entity"));
			DamageSourcePredicate damagesourcepredicate = DamageSourcePredicate
					.func_192447_a(jsonobject.getOptional("type"));
