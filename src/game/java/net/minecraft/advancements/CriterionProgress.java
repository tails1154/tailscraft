...
public class CriterionProgress {
	...
	public Object func_192148_e() {
		return (Object) (this.field_192157_c != null ? new String(field_192155_a.format(this.field_192157_c)) : null);
	}
	...
	public static CriterionProgress func_192152_a(AdvancementProgress p_192152_0_, String p_192152_1_) {
		...
		try {
			...
			throw new JSONException("Invalid datetime: " + p_192152_1_, parseexception);
		}
	}
}
