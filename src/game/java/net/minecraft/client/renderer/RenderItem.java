...
public class RenderItem implements IResourceManagerReloadListener {
	...
	public RenderItem(TextureManager p_i46552_1_, ModelManager p_i46552_2_, ItemColors p_i46552_3_) {
		...
		this.itemModelMesher = new ItemModelMesher(this.modelManager);
		this.registerItems();
	...
	private void func_191966_a(IBakedModel p_191966_1_) {
		if (!Config.isCustomItems() || CustomItems.isUseGlint()) {
			...
			GlStateManager.blendFunc(RealOpenGLEnums.GL_SRC_COLOR, RealOpenGLEnums.GL_ONE);
	...
	private void func_191969_a(WorldRenderer p_191969_1_, BakedQuad p_191969_2_, int p_191969_3_) {
	...
	private void func_191970_a(WorldRenderer p_191970_1_, List<BakedQuad> p_191970_2_, int p_191970_3_,
	...
	protected void renderItemModel(ItemStack stack, IBakedModel bakedmodel,
		...
		if (!stack.func_190926_b()) {
			...
			if (this.isThereOneNegativeScale(itemcameratransforms.getTransform(transform))) {
				GlStateManager.cullFace(RealOpenGLEnums.GL_FRONT);
			}
	...
	private void registerItems() {
		...
		for (EnumDyeColor enumdyecolor : EnumDyeColor.values()) {
			this.registerBlock(Blocks.CONCRETE, enumdyecolor.getMetadata(), enumdyecolor.func_192396_c() + "_concrete");
			this.registerBlock(Blocks.CONCRETE_POWDER, enumdyecolor.getMetadata(),
