...
public class RenderLightningBolt extends Render<EntityLightningBolt> {
	...
	public void doRender(EntityLightningBolt entity, double x, double y, double z, float entityYaw,
		...
		GlStateManager.blendFunc(RealOpenGLEnums.GL_SRC_ALPHA, RealOpenGLEnums.GL_ONE);
		double[] adouble = new double[8];
		double[] adouble1 = new double[8];
		double d0 = 0.0D;
		double d1 = 0.0D;
		EaglercraftRandom random = new EaglercraftRandom(entity.boltVertex);
		...
		for (int k1 = 0; k1 < 4; ++k1) {
			EaglercraftRandom random1 = new EaglercraftRandom(entity.boltVertex);
