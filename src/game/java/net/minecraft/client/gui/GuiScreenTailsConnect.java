...
public class GuiScreenTailsConnect extends GuiScreen {
	...
	public void initGui() {
		buttonList.clear(); buttonList.add(new GuiButton(0, width / 2 - 100, height / 4 + 173, 98, 20, I18n.format("menu.tailsConnect.back")));
		buttonList.add(new GuiButton(5, width / 2 + 2, height / 4 + 173, 98, 20, "Stop / Cancel"));
