...
public class GuiListWorldSelectionEntry implements GuiListExtended.IGuiListEntry {
	...
	private void loadServerIcon() {
		boolean flag = this.iconFile != null && this.iconFile.exists();

		if (flag) {
			ImageData bufferedimage;

			try {
				bufferedimage = ImageData.loadImageFile(this.iconFile.getAllBytes());
			...
			bufferedimage.getRGB(0, 0, bufferedimage.width, bufferedimage.height, this.icon.getTextureData(), 0,
					bufferedimage.width);
