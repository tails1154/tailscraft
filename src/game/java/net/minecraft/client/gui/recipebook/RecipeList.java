...
public class RecipeList {
	private ObjectArrayList<IRecipe> field_192713_b = new ObjectArrayList<IRecipe>();
	...
	public void func_194214_a(RecipeBook p_194214_1_) {
		for (int i = 0; i < this.field_192713_b.size(); ++i) {
			if (p_194214_1_.func_193830_f(this.field_192713_b.get(i))) {
				this.field_194217_d.set(i);
			} else {
				this.field_194217_d.clear(i);
			}
		}
	}
	...
	public void func_194210_a(RecipeItemHelper p_194210_1_, int p_194210_2_, int p_194210_3_, RecipeBook p_194210_4_) {
		for (int i = 0; i < this.field_192713_b.size(); ++i) {
			...
			if (flag) {
				this.field_194216_c.set(i);
			} else {
				this.field_194216_c.clear(i);
			}
			if (flag && p_194210_1_.func_194116_a(irecipe, (IntArrayList) null)) {
				this.field_194215_b.set(i);
			} else {
				this.field_194215_b.clear(i);
			}
		}
	}
	...
	public ObjectArrayList<IRecipe> func_192711_b() {
